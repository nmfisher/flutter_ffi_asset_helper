...
extern "C" {
    ...
    JNIEXPORT jint JNICALL Java_app_polyvox_flutter_1ffi_1asset_1helper_FlutterFfiAssetHelperPlugin_closeFd(JNIEnv *env, jobject obj,  jobject assetManager, jint fd) {
        close((int)fd);
        return 0;
    }
